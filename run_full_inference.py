...
def _build_mol_features_row(
    ...
    # Age at diagnosis, from the same `age_at_event_days` column DL-M1 reads
    # (DL-M1's wrangler likewise renames it to "Age at Diagnosis"). Both models
    # take the single age the user supplies; only the scaler differs, since each
    # was fit on its own cohort.
